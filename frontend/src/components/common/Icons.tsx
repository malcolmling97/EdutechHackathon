...
import { FaUserAlt, FaBookOpen, FaComments, FaCog, FaStickyNote, FaBrain, FaChevronLeft, FaChevronRight, FaUpload, FaMicrophone, FaPaperclip, FaFilePdf, FaRegListAlt, FaRegClone, FaQuestionCircle, FaRegEdit } from 'react-icons/fa';
